...
HD_PWD='/afs/athena.mit.edu/user/a/d/addiaz15/FPGuitAr/project_2/project_2.runs/image_rom_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rom_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rom_map.tcl
