...
HD_PWD='/afs/athena.mit.edu/user/a/d/addiaz15/FPGuitAr/project_2/project_2.runs/alph_map_red_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alph_map_red_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alph_map_red_rom.tcl
